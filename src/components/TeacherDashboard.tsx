...
-- Drop ALL existing default/custom policies dynamically to prevent recursion or naming conflicts
DO $$
DECLARE
    pol RECORD;
BEGIN
...
-- RECOMMENDED RESOLUTION: Disable Row Level Security (RLS) entirely.
--- This prevents recursive queries or security rules from causing connection blocks.
ALTER TABLE public.school_config DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.faculty_profiles DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.students DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.subject_grades DISABLE ROW LEVEL SECURITY;
